                ...
                <table class="table table-striped table-sm">
                    ...
                    <c:forEach items="${list}" var="e">
                        <tr>
                            ...
                            <td>${e.adresse}</td>
                            <td>
                                <a href="<c:url value='/entreprise/edit?id=${e.num}' />" class="btn-sm btn-primary"> <span data-feather="edit"></span></a>
                                <a onclick="return confirm('Etes vous sûr de vouloir supprimer?')" href="<c:url value='/entreprise/delete?id=${e.num}' />" class="btn-sm btn-danger"> <span data-feather="trash-2"></span></a>
                            </td>
                        </tr>
                    </c:forEach>
